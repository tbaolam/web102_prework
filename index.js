...
function addGamesToPage(games) {
    ...
    for (const game of games){   
        ...
        div.innerHTML = `<p>Name: ${game.name}</p>`;
...
// use reduce to find the total number of games
const totalGames = GAMES_JSON.length;

// create a string that explains the number of unfunded games using the ternary operator
var unfundedString = `A total of ${totalRaised} has been raised for ${totalGames} games.`;
unfundedString += numUnfunded === 1 ? "There is 1 game that still needs funding." : `There are ${numUnfunded} games that still need funding.`;
